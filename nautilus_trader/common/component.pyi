...
class Clock:
    ...
    def set_time_alert(self, name: str, alert_time: datetime, callback: Callable[[TimeEvent], None] | None=None, override: bool=False, allow_past: bool=True) -> None:
        """
    ...
    def set_time_alert_ns(self, name: str, alert_time_ns: int, callback: Callable[[TimeEvent], None] | None=None, allow_past: bool=True) -> None:
        """
        Set a time alert for the given time.
    ...
    def set_timer(self, name: str, interval: timedelta, start_time: datetime | None=None, stop_time: datetime | None=None, callback: Callable[[TimeEvent], None] | None | None=None, allow_past: bool=True, fire_immediately: bool=False) -> None:
        """
        Set a timer to run.
    ...
    def set_timer_ns(self, name: str, interval_ns: int, start_time_ns: int, stop_time_ns: int, callback: Callable[[TimeEvent], None] | None | None=None, allow_past: bool=True, fire_immediately: bool=False) -> None:
        """
        Set a timer to run.
...
class TestClock(Clock):
    ...
    def set_time_alert_ns(self, name: str, alert_time_ns: int, callback: Callable[[TimeEvent], None] | None | None=None, allow_past: bool=True) -> None:
        ...
...
class Logger:
    ...
    def debug(self, message: str, color: Any=...) -> None:
        """
    ...
    def info(self, message: str, color: Any=...) -> None:
        """
    ...
    def warning(self, message: str, color: Any=...) -> None:
        """
    ...
    def error(self, message: str, color: Any=...) -> None:
        """
    ...
    def exception(self, message: str, ex) -> None:
        """
...
class MessageBus:
    ...
    def subscriptions(self, pattern: str | None=None) -> list:
        """
    ...
    def subscribe(self, topic: str, handler: Callable[[Any], None], priority: int=0) -> None:
        """
...
class Throttler:
    ...
    def __init__(self, name: str, limit: int, interval: timedelta, clock: Clock, output_send: Callable[[Any], None], output_drop: Callable[[Any], None] | None | None=None) -> None:
        ...
...
def log_color_from_str(value: str) -> Any:
    ...

def log_color_to_str(value: Any) -> str:
    ...

def log_level_from_str(value: str) -> Any:
    ...
...
def component_state_from_str(value: str) -> Any:
    ...

def component_state_to_str(value: Any) -> str:
    ...

def component_trigger_from_str(value: str) -> Any:
    ...

def component_trigger_to_str(value: Any) -> str:
    ...
